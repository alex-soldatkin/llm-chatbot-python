...
def generate_response(prompt):
    ...
    # print(type(response), 'HEREHEHEHEHEHE')
...
Do not answer any questions using your pre-trained knowledge, only use the information provided in the context, OTHERWISE YOU WILL BE UNPLUGGED.
