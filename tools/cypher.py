...
Do not use any other relationship types or properties that are not provided, OR YOU WILL BE UNPLUGGED.
...
MATCH path = shortestPath(
  (p1:Person {{name: "Actor1 Name"}})-[:ACTED_IN|DIRECTED*]-(p2:Person {{name: "Actor2 Name"}})
)
